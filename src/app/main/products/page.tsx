              ...
              return (
                ...
                >
                  <div className="g-card-visual">
                    {p.images?.[0] ? (
                      <Image src={p.images[0]} alt={p.name} fill style={{ objectFit: 'cover', transition: 'transform 0.6s cubic-bezier(.16,1,.3,1)' }} />
                    ) : (
          ...
          <div className="g-drawer" ref={drawerRef}>
            ...
            <div className="g-drawer-gallery">
              {selected.images?.[imgIdx] ? (
                <Image src={selected.images[imgIdx]} alt={selected.name} fill style={{ objectFit: 'cover' }} />
              ) : (
                    ...
                    {categoryProducts.map(catProd => (
                      ...
                      >
                        <div className="g-category-card-image">
                          {catProd.images?.[0] ? (
                            <Image src={catProd.images[0]} alt={catProd.name} fill style={{ objectFit: 'cover' }} />
                          ) : (
                  ...
                  {recs.map(r => (
                    <div key={r.id} className="g-rec" onClick={() => { setSelected(r); setImgIdx(0); drawerRef.current?.scrollTo({ top: 0, behavior: 'smooth' }); }}>
                      <div className="g-rec-img">
                        {r.images?.[0]
                          ? <Image src={r.images[0]} alt={r.name} width={50} height={50} style={{ objectFit: 'cover', width: '100%', height: '100%' }} />
