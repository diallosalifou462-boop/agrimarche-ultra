...
export default function MainPage() {
  // Version 1: Utiliser une seed fixe pour des valeurs déterministes
    ...
    <div className="sacred-container">
        ...
        * {
        ...
        .celestial-breath {
          ...
          background: radial-gradient(
            ...
            rgba(230, 255, 220, 0.25) 0%,
            rgba(80, 150, 90, 0.05) 40%,
            transparent 70%
          );
        ...
        @keyframes riseSlow {
          ...
          100% {
            transform: translateY(-15vh) translateX(35px);
            opacity: 0;
          }
        }
        ...
        .sacred-emblem:hover {
          ...
          box-shadow: 0 40px 60px -22px rgba(35, 85, 50, 0.45);
        }
        ...
        @keyframes breathLight {
          0%, 100% {
            ...
            text-shadow: 0 0 0px rgba(45, 100, 65, 0);
          }
          50% {
            letter-spacing: 0.015em;
            text-shadow: 0 0 12px rgba(55, 120, 75, 0.1);
          }
        }
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-6 py-12">
        ...
        <h1 className="text-7xl md:text-9xl font-black text-center tracking-tighter">
          <span className="name-breath inline-block text-emerald-800 drop-shadow-sm">
            AGRI
          </span>
          <span className="name-breath inline-block text-emerald-500" style={{ animationDelay: '0.2s' }}>
            MARCHÉ
          </span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-6 mt-16">
          <Link
            href="/main/products"
            className="gate-btn bg-gradient-to-r from-emerald-800 to-emerald-600 hover:from-emerald-700 hover:to-emerald-500 text-white px-12 py-4 rounded-full font-bold shadow-2xl transition-all duration-300 text-center tracking-wide"
            onMouseMove={(e) => {
          ...
          <Link
            href="/main/account"
            className="gate-outline border-2 border-emerald-500 text-emerald-700 bg-white/30 px-12 py-4 rounded-full font-bold transition-all duration-300 text-center shadow-md hover:shadow-xl"
          >
            mon profil
          </Link>
        </div>
